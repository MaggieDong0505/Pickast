...
export const initialData: BriefingCardData = {
  ...
  "mainEpisode": {
    ...
    "publishedAt": "2026-06-11T14:09:04+00:00",
    ...
    "whyRecommended": "适合对AI、技术停滞与文明风险有深度兴趣的听众，一场跨越科技、政治与历史的思维风暴。",
    "viewpoints": [
    ...
    "whyRecommend": "适合对AI、技术停滞与文明风险有深度兴趣的听众，一场跨越科技、政治与历史的思维风暴。",
    "goldenQuote": "你实际生活的环境，一百年来并没有改变。",
    "topicTag": "📖值得精听｜内容密度极高，需专注思考"
  },
  "backupEpisodes": [
    {
      ...
      "scenario": "",
      "whyRecommend": "职场沟通实战指南，适合想提升汇报、加薪、跨部门协作效率的上班族，有具体话术和框架。",
    ...
    },
    {
      ...
      "coverBg": "bg-[#18181B]",
      "coverTextColor": "text-amber-50",
      "whyRecommended": "想理解韩国股市暴涨与K型社会真相的听众，这期用3K主线串联经济、文化与历史，信息密度极高。",
      "viewpoints": [
        "韩国股市2026年翻倍，SK海力士涨超10倍，三星市值破万亿。",
        "Kpop与半导体共享出口导向、标准化生产的韩国经济逻辑。",
        "韩国家庭债务收入比170%，净储蓄率仅4%，社会K型分化加剧。"
      ],
      "goldenQuotes": [],
      "triageTag": "📖值得精听｜信息密集，需专注理解",
      "href": "cosmos://page.cos/episode/6a242507b30e1571aea1b88d?utm_source=rss",
      "scenario": "",
      "whyRecommend": "想理解韩国股市暴涨与K型社会真相的听众，这期用3K主线串联经济、文化与历史，信息密度极高。",
      "goldenQuote": "想理解韩国股市暴涨与K型社会真相的听众，这期用3K主线串联经济、文化与历史，信息密度极高。",
      "topicTag": "📖值得精听｜信息密集，需专注理解"
    }
  ],
  "synthesis": null
};
