...
export const initialData: BriefingCardData = {
  ...
  "backupEpisodes": [
    ...
    },
    {
      ...
      "coverBg": "bg-[#18181B]",
      "coverTextColor": "text-amber-50",
      "whyRecommended": "适合对太空经济与AI算力感兴趣的人，从成本、技术、战略三角度拆解SpaceX的太空数据中心计划。",
      "viewpoints": [
        "SpaceX招股书预测太空算力市场超90%来自AI板块",
        "太空数据中心面临散热、辐射、成本三大技术挑战",
        "星舰每公斤发射成本需降至10-20美元经济账才成立"
      ],
      "goldenQuotes": [
        {
      ...
      "scenario": "",
      "whyRecommend": "适合对太空经济与AI算力感兴趣的人，从成本、技术、战略三角度拆解SpaceX的太空数据中心计划。",
